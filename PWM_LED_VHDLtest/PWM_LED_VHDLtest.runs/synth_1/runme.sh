...
HD_PWD='C:/Users/Ying/Desktop/HDL_projects/PWM_LED_VHDLtest/PWM_LED_VHDLtest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSeg_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SevenSeg_Demo.tcl
