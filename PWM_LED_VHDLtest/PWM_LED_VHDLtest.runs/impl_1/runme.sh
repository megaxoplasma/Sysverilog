...
HD_PWD='C:/Users/Ying/Desktop/HDL_projects/PWM_LED_VHDLtest/PWM_LED_VHDLtest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSeg_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SevenSeg_Demo.tcl -notrace
