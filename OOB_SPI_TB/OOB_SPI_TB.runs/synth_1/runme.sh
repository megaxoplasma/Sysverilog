...
HD_PWD='C:/Users/Ying/Desktop/HDL_projects/OOB_SPI_TB/OOB_SPI_TB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_If.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_If.tcl
