...
HD_PWD='C:/Users/Ying/Desktop/HDL_projects/twos_comp_adder/twos_comp_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TwosCompAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TwosCompAdder.tcl
