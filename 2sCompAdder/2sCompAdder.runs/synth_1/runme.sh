...
HD_PWD='C:/Users/Ying/Desktop/HDL_projects/2sCompAdder/2sCompAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CompAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CompAdder.tcl
