...
HD_PWD='C:/Users/Ying/Desktop/HDL_projects/RightRotate_FPGA/RightRotate_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RightRotate_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RightRotate_top.tcl -notrace
