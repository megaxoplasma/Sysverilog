...
HD_PWD='C:/Users/Ying/Desktop/HDL_projects/RightRotate_FPGA/RightRotate_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RightRotate_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RightRotate_top.tcl
